...
{
    /// <inheritdoc />
    public partial class AddObservable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Title = table.Column<string>(type: "TEXT", nullable: false, comment: "歌名"),
                    ...
                    LyricFilePath = table.Column<string>(type: "TEXT", nullable: true, comment: "歌词路径")
                },
                constraints: table =>
                {
